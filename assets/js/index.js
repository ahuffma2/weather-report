  ...
  fetch(location)
    .then(function (response) {
      if (response.status !== 200) {
        alert("Error " + response.statuse);
      }
      return response.json();
    })

    .then(function (data) {
      //THIS FUNCTION RETRIEVES PERTINENT DATA AND ASSIGNS THEM TO AN OBJECT FOR EASY READBILITY. THE WHOLE OF THIS FUNCTION IS JUST ASSIGNING CORRESPONDING DATA TO THEIR RESPECTIVE HTML ELEMENTS.
      var weatherObject = {
        City: data.name,
